...
tf.flags.DEFINE_string("raw_path", "data/raw/LREC", "path to raw dataset")
...
tf.flags.DEFINE_string("vocab", "data/dataset/lrec/pd_vocab.json", "path to the word and tag vocabularies")
tf.flags.DEFINE_string("train_set", "data/dataset/lrec/pd_train.json", "path to the training datasets")
tf.flags.DEFINE_string("dev_set", "data/dataset/lrec/pd_dev.json", "path to the development datasets")
tf.flags.DEFINE_string("dev_text", "data/raw/LREC/2014_dev.txt", "path to the development text")
tf.flags.DEFINE_string("test_set", "data/dataset/lrec/bert_ref.json", "path to the ref test datasets")
tf.flags.DEFINE_string("test_text", "data/raw/LREC/2014_test.txt", "path to the ref text")
